export const membersData = [
    { name: 'Marc Huertas-Company', role: 'Faculty', researchArea: 'Galaxy Evolution', author: 'Huertas-Company, M.' },
    { name: 'Andrés Asensio-Ramos', role: 'Faculty', researchArea: 'Solar Physics', author: 'Asensio-Ramos, A.' },
    { name: 'Carlos Westendorp', role: 'Faculty', researchArea: 'Multi Disciplinary ML applications', author: 'Westendorp, C.' },
...
export const authors = membersData.map(member => member.author);
